...
import { Alert, AlertType, Camera, User } from '@prisma/client';
...
export const processCameraAlert: RequestHandler = async (req: AuthenticatedRequest, res, next: NextFunction) => {
